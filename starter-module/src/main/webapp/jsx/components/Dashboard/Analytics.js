    ...
    <>
      <div className="form-head mb-4 d-flex flex-wrap align-items-center">
        ...
        <Dropdown className="dropdown custom-dropdown mb-2 period-btn">
          <Dropdown.Toggle
            as="div"
            className="btn btn-sm  d-flex align-items-center i-false c-pointer"
          >
            <svg
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="row">
            <div className="col-xl-12">
              <div className="card bg-primary">
                <div className="card-header border-0 pb-0 align-items-center justify-content-center">
                  <div className="me-auto">
                    <h4 className="chart-num-3 mb-0 text-white">
                      Sales Comparison
                    </h4>
                    <span className="chart-num-3 font-w100 text-white">
                      Than last day
                    </span>
                  </div>
                  <span className="font-w600 me-2 text-white chart-num-2">
                    94%
                  </span>
                  <svg
                    width="27"
                ...
                <div className="card-body pb-0 p-2">
                  <div id="line-chart-2">{/* <SalesBarApex /> */}</div>
                </div>
              </div>
            </div>
            <div className="col-xl-12">{/* <BestSellingTab /> */}</div>
                    ...
                    <Dropdown className="ms-auto float-end default-select">
                      ...
                      <Dropdown.Menu className="dropdown-menu dropdown-menu-end">
                        <Dropdown.Item
                          ...
                          onClick={() => setControl3("This Week")}
                        >
                          This Week
                        </Dropdown.Item>
                        <Dropdown.Item
                          className="py-0 text-primary"
                          onClick={() => setControl3("Next Week")}
                        >
                          Next Week
                        </Dropdown.Item>
                      </Dropdown.Menu>
            ...
            <div className="col-xxl-12 col-md-6">
              <div className="card">
                <div className="card-header pb-0 border-0">
                  <h4 className="fs-20 font-w600 mb-0">Customers </h4>
                </div>
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    <div className="d-inline-block position-relative donut-chart-sale mb-3">
                      {/* {background.value === "dark" ? (
											  ...
											  <AnalyticsDonut value={29} backgroundColor="rgb(14, 138, 116,1)" />
											)} */}
                      <small>29%</small>
                    </div>
                    <div className="ms-4">
                  ...
                  <div className="d-flex align-items-center mt-4 justify-content-center">
                    <div className="d-inline-block position-relative donut-chart-sale mb-3">
                      {/* {background.value === "dark" ? (
                        ...
                        <AnalyticsDonut
                          value={84}
                          backgroundColor="rgb(14, 138, 116,1)"
                        />
                      )} */}
                      <small>84%</small>
                    </div>
        ...
        <div className="col-xl-6">
          <div className="row">
            <div className="col-xl-12">
              <div className="card">
                <div className="card-header border-0 pb-0 flex-wrap">
                  <h4 className="fs-20 mb-0  font-w500">Best Selling</h4>
                  <Dropdown className=" float-end default-select">
                    ...
                    <Dropdown.Menu className="dropdown-menu dropdown-menu-end">
                      <Dropdown.Item
                        className="py-0  text-primary"
                        onClick={() => setControl2("Monthly")}
                      >
                        Monthly
                      </Dropdown.Item>
                      <Dropdown.Item
                        className="py-0 text-primary"
                        onClick={() => setControl2("Weekly")}
                      >
                        Weekly
                      </Dropdown.Item>
                      <Dropdown.Item
                        className="py-0 text-primary"
                        onClick={() => setControl2("Daily")}
                      >
                        Daily
                      </Dropdown.Item>
                    </Dropdown.Menu>
                ...
                <div className="card-body pb-2">
                  ...
                  <div className="row align-items-center">
                    <div className="col-sm-6 p-0">
                      <div id="lineChart">{/* <WidgetChart1 /> */}</div>
                    </div>
            ...
            <div className="col-xl-6 col-xxl-12 col-sm-6">
              <div className="card">
                <div className="card-header align-items-start pb-0 border-0">
                  <span className="fs-20 font-w400 mb-0 ticket-size">
                    Ticket Sold
                  </span>
                ...
                <div className="card-header align-items-center pb-2 pt-2 border-0">
                  ...
                  <Dropdown className=" float-end default-select">
                    ...
                    <Dropdown.Menu className="dropdown-menu dropdown-menu-end">
                      <Dropdown.Item
                        className="py-0  text-primary"
                        onClick={() => setControl("Monthly")}
                      >
                        Monthly
                      </Dropdown.Item>
                      <Dropdown.Item
                        className="py-0 text-primary"
                        onClick={() => setControl("Weekly")}
                      >
                        Weekly
                      </Dropdown.Item>
                      <Dropdown.Item
                        className="py-0 text-primary"
                        onClick={() => setControl("Daily")}
                      >
                        Daily
                      </Dropdown.Item>
                    </Dropdown.Menu>
                ...
                <div className="card-header align-items-center pb-0 border-0">
                  ...
                  <Dropdown className=" float-end default-select">
                    ...
                    <Dropdown.Menu className="dropdown-menu dropdown-menu-end">
                      <Dropdown.Item
                        className="py-0  text-primary"
                        onClick={() => setControl4("Monthly")}
                      >
                        Monthly
                      </Dropdown.Item>
                      <Dropdown.Item
                        className="py-0 text-primary"
                        onClick={() => setControl4("Weekly")}
                      >
                        Weekly
                      </Dropdown.Item>
                      <Dropdown.Item
                        className="py-0 text-primary"
                        onClick={() => setControl4("Daily")}
                      >
                        Daily
                      </Dropdown.Item>
                    </Dropdown.Menu>
                    ...
                    <div className="">
                      <Dropdown className=" float-end default-select">
                        ...
                        <Dropdown.Menu className="dropdown-menu dropdown-menu-end">
                          <Dropdown.Item
                            className="py-0  text-primary"
                            onClick={() => setControl5("Monthly")}
                          >
                            Monthly
                          </Dropdown.Item>
                          <Dropdown.Item
                            className="py-0 text-primary"
                            onClick={() => setControl5("Weekly")}
                          >
                            Weekly
                          </Dropdown.Item>
                          <Dropdown.Item
                            className="py-0 text-primary"
                            onClick={() => setControl5("Daily")}
                          >
                            Daily
                          </Dropdown.Item>
                        </Dropdown.Menu>
                      ...
                      <ul className="index-chart-point-list">
                        <li>
                          <i className="fa fa-stop text-danger"></i>Tickets A
                        </li>
                        <li>
                          <i className="fa fa-stop text-info"></i> Tickets B
                        </li>
                        <li>
                          <i className="fa fa-stop text-success"></i> Tickets C
                        </li>
                        <li>
                          <i className="fa fa-stop text-warning"></i> Tickets D
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="col-xl-12">{/* <TrendingItems /> */}</div>
          </div>
        </div>
      </div>
    </>
