...
const PatientFlagCreation = (props) => {
    ...
    const handleSaveNotification = () => {
        axios
            .post(`${baseUrl}patient-flag/`, notificationObject, { headers: { "Authorization": `Bearer ${token}` } })
            .then(response => {
                setNotificationObject(null)
                props.toggleModal()
                props.fetchNotificationConfigs()
                toast.success("Patient Flag Config successfully saved...")
            })
            .catch(error => {
                console.log(error)
            }
    ...
    return (
        <Modal show={props.showModal} size="lg">
            <Modal.Header toggle={props.toggleModal}>
                ...
                <Modal.Title>Create Patient Flag Config</Modal.Title>
                <Button
                    variant=""
                    className="btn-close"
            ...
            <Modal.Body>
                ...
                <Col md={12}>
                    <FormGroup>
                        ...
                        <Input
                            ...
                            onChange={handleChange}
                            style={{ border: "1px solid #014D88", borderRadius: "0.2rem" }}
                            value={notificationObject?.surpressionValue}
                        >
                        </Input>
                    </FormGroup>
                </Col>
                ...
                {/* <Col md={12}>
                    <FormGroup>
                        <Label style={{ color: '#014d88', fontWeight: 'bolder' }}> Enter Api  <span style={{ cursor: "pointer", color: "blue" }}
                        >
                        </span></Label>
                        <Input
                            type="text"
...
export default PatientFlagCreation;