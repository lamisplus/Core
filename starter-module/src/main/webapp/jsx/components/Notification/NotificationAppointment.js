...
const Notification = (props) => {
    ...
    const openNotificationConfigDeletionModal = (row) => {
        axios
            .delete(`${baseUrl}notification/${row}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                setModal(false)
    ...
    return (
        <>
            ...
            <NewNotificationConfigModal toggleModal={toggleModal} showModal={showCreationModal}
            ...
            <Card>
                <CardBody >
                    <div className={"d-flex justify-content-end"}>
                        ...
                        >
                            <span style={{ textTransform: 'capitalize' }}>Add Notification Config</span>
                        </ButtonMui>}
                    </div>
                    <MaterialTable
                        icons={tableIcons}
                    ...
                    <Modal show={modal}>
                        ...
                        <Modal.Header>
                            <Modal.Title>Delete Notification Config </Modal.Title>
                            <Button
                                variant=""
                                className="btn-close"
                        ...
                        <Modal.Body>
                            <p>Are you sure you want to delete Notification Config</p>
                        </Modal.Body>
                        <Modal.Footer>
                            <MatButton
                                type="submit"
